...
setwd('dataExternal/raw/S126/Trimmed/')
...
setwd(gcswd)
n = make.names(paste('CFastqQuality trimmed S126 run for Miho BS Seq project id 8'))
lOb$meta.1 = dfSample
lOb$meta.2 = dfFiles
lOb$desc = paste('CFastqQuality object trimmed S126 run for Miho BS Seq project id 8', date())
