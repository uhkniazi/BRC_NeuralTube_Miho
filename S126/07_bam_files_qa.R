...
setwd(gcswd)
n = make.names(paste('CBamScaffold rd picard bs seq S126 miho rds'))
lAllBams$metaBismark = dfBismark
lAllBams$meta = dfSample
lAllBams$desc = paste('CBamScaffold object from S126 run for bs seq data for miho ishida with quality 10 duplicates removed using picard tools', date())
