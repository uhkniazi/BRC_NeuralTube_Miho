...
g_did
dfSample = dbGetQuery(db, "select * from Sample where idData=27;")
...
setwd('dataExternal/raw/raw/S184/processed/')
...
setwd(gcswd)
n = make.names(paste('CFastqQuality S184 run for Miho BS Seq project id 8'))
lOb$meta.1 = dfSample
lOb$meta.2 = dfFiles
lOb$desc = paste('CFastqQuality object S184 run for Miho BS Seq project id 8', date())
...
df = data.frame(idData=g_did, name=n, type='rds', location='~/Data/MetaData/', comment='S184 run for Miho BS Seq project FASTQ file quality data')
