...
cSampleCol
dfSamples = data.frame(idProject=g_pid, idData=g_did, title=unique(fSplit), description='S135 run for Miho BS Seq project')
...
g_did
dfSamples = dbGetQuery(db, paste('select * from Sample where Sample.idData = 20;'))
