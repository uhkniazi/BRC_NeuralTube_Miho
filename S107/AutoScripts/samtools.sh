...
java -Xmx30G -jar /opt/apps/bioinformatics/picard-tools/2.2.1/picard.jar SortSam OUTPUT=$bamq10sort INPUT=$bamq10 SORT_ORDER=queryname VALIDATION_STRINGENCY=SILENT
java -Xmx30G -jar /opt/apps/bioinformatics/picard-tools/2.2.1/picard.jar MarkDuplicates I=$bamq10sort O=$bamrd REMOVE_DUPLICATES=true VALIDATION_STRINGENCY=SILENT
