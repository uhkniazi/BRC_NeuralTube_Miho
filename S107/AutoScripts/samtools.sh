...
java -Xmx30G -jar /opt/apps/bioinformatics/picard-tools/2.2.1/picard.jar MarkDuplicates I=$bamq10sort O=$bamrd M=$bamrd_duplicate_metrics.txt REMOVE_DUPLICATES=true VALIDATION_STRINGENCY=SILENT
